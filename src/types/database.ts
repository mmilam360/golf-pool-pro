...
export interface Database {
  public: {
    Tables: {
      ...
      gpp_tournaments: {
        Row: { id: string; external_id: string | null; name: string; course: string | null; location: string | null; start_date: string; end_date: string; season: number | null; tour: string; status: string; field_json: Json | null; leaderboard_json: Json | null; cut_score: number | null; last_scores_fetch: string | null; odds_snapshot_json: Json | null; odds_source: string | null; odds_event_id: string | null; odds_captured_at: string | null; created_at: string; updated_at: string }
        Insert: { id?: string; external_id?: string; name: string; course?: string; location?: string; start_date: string; end_date: string; season?: number; tour?: string; status?: string; field_json?: Json; leaderboard_json?: Json; cut_score?: number; odds_snapshot_json?: Json; odds_source?: string; odds_event_id?: string; odds_captured_at?: string }
        Update: { name?: string; status?: string; field_json?: Json; leaderboard_json?: Json; cut_score?: number; last_scores_fetch?: string; odds_snapshot_json?: Json; odds_source?: string; odds_event_id?: string; odds_captured_at?: string }
      }
      gpp_pools: {
        Row: { id: string; tournament_id: string; name: string; passcode: string; owner_id: string; pick_count: number; count_scores: number; ob_rule_enabled: boolean; ob_penalty_strokes: number; require_entry_email: boolean; buy_in_amount: number; payout_structure: Json | null; is_locked: boolean; lock_at: string | null; is_completed: boolean; payment_status: 'draft' | 'active' | 'payment_due' | 'archived_unpaid' | 'refunded'; paid_entry_limit: number; amount_paid_cents: number; activated_at: string | null; last_payment_at: string | null; square_customer_id: string | null; square_payment_ids: string[]; square_order_ids: string[]; created_at: string; updated_at: string }
        Insert: { id?: string; tournament_id: string; name: string; passcode?: string; owner_id: string; pick_count?: number; count_scores?: number; ob_rule_enabled?: boolean; ob_penalty_strokes?: number; require_entry_email?: boolean; buy_in_amount?: number; payout_structure?: Json; is_locked?: boolean; lock_at?: string; payment_status?: 'draft' | 'active' | 'payment_due' | 'archived_unpaid' | 'refunded'; paid_entry_limit?: number; amount_paid_cents?: number; activated_at?: string | null; last_payment_at?: string | null; square_customer_id?: string | null; square_payment_ids?: string[]; square_order_ids?: string[] }
        Update: { name?: string; pick_count?: number; count_scores?: number; ob_rule_enabled?: boolean; ob_penalty_strokes?: number; require_entry_email?: boolean; buy_in_amount?: number; payout_structure?: Json; is_locked?: boolean; lock_at?: string; is_completed?: boolean; payment_status?: 'draft' | 'active' | 'payment_due' | 'archived_unpaid' | 'refunded'; paid_entry_limit?: number; amount_paid_cents?: number; activated_at?: string | null; last_payment_at?: string | null; square_customer_id?: string | null; square_payment_ids?: string[]; square_order_ids?: string[] }
      }
      gpp_entries: {

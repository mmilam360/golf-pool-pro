    ...
    <main className="min-h-screen scorecard-paper text-[#1f2a24]">
      ...
      <section data-campaign-section="why" className="border-b-2 border-[#123c2f] bg-white/80 py-10">
        <div className="mx-auto grid max-w-7xl gap-4 px-4 md:grid-cols-3 md:px-8">
          {[
            ['Built for phones', 'Players can check standings without pinching around a spreadsheet.'],
            ['Invite by link', 'Share one link or passcode and let players enter their own picks.'],
            ['Rules stay clear', 'Cuts, OB stand-ins, locks, and scoring live in the pool instead of a group text argument.'],
          ].map(([title, body]) => (

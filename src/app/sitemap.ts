...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    {
      url: `${siteUrl}/golf-pool-software`,
      lastModified,
      changeFrequency: 'monthly',
      priority: 0.9,
    },
    {
      url: `${siteUrl}/office-golf-pool`,
      lastModified,
      changeFrequency: 'monthly',
      priority: 0.85,
    },
    {
      url: `${siteUrl}/live-golf-pool-leaderboard`,
      lastModified,
      changeFrequency: 'monthly',
      priority: 0.85,
    },
    {
      url: `${siteUrl}/easy-office-pools-alternative`,
      lastModified,
      changeFrequency: 'monthly',
      priority: 0.7,
    },
    ...
    {
      url: `${siteUrl}/charles-schwab-challenge-pool`,
      lastModified,
      changeFrequency: 'weekly',
      priority: 0.85,
    },
    ...
    {
      url: `${siteUrl}/rbc-canadian-open-pool`,
      lastModified,
      changeFrequency: 'weekly',
      priority: 0.85,
    },
    {
      url: `${siteUrl}/travelers-championship-pool`,
      lastModified,
      changeFrequency: 'weekly',
      priority: 0.85,
    },

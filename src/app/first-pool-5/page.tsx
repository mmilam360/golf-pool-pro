...
export const metadata: Metadata = {
  ...
  description: 'A newer mobile golf pool app for pool runners. First pool capped at $5 with mobile picks, live leaderboards, PGA scoring, and simple pool management.',
  alternates: {
    canonical: 'https://www.golfpoolspro.com/first-pool-5',
  },
  robots: {
    index: false,
    follow: true,
      ...
      <div className="grid sm:grid-cols-[128px_1fr]">
        <div className="flex items-center justify-center border-b-2 border-[#123c2f] bg-white px-4 py-5 text-center sm:border-b-0 sm:border-r-2 sm:border-dashed">
          <div>
            ...
            <p className="mt-1 text-5xl font-black leading-none text-[#123c2f]">$5</p>
        ...
        <div className="px-4 py-5">
          ...
          <p className="mt-2 text-sm font-semibold leading-5 text-stone-700">Your first pool is capped at $5. The offer saves to your account and applies at checkout.</p>
        </div>
      </div>
    </div>
  )
...
export default function FirstPoolFivePage() {
  return (
    <main className="min-h-screen scorecard-paper text-[#1f2a24]">
      <FirstPoolCampaignTracker campaign="first_pool_5_fb" eventPrefix="first_pool_5" />
      ...
      <section data-campaign-section="hero" className="mx-auto grid max-w-7xl gap-8 px-4 py-10 md:grid-cols-[1.05fr_0.95fr] md:px-8 md:py-14">
        <div className="flex flex-col justify-center">
          ...
          <p className="mt-5 max-w-2xl text-lg font-semibold leading-7 text-stone-700">
            Run your Open Championship pool from one clean mobile leaderboard. Players make picks on their phones and follow the board as the tournament moves.
          </p>
          <div className="mt-6 max-w-xl">
            <DiscountTicket />
          </div>
          <div className="mt-6 flex flex-col gap-3 sm:flex-row">
            <FirstPoolCampaignLink campaign="first_pool_5_fb" eventPrefix="first_pool_5" href="#signup" location="hero" className="border-2 border-[#123c2f] bg-[#123c2f] px-5 py-3 text-center font-black uppercase tracking-[0.08em] text-white hover:bg-[#0f2f25]">
              Start with the $5 offer
      ...
      <section data-campaign-section="signup" id="signup" className="mx-auto grid max-w-7xl gap-8 px-4 py-10 md:grid-cols-[0.9fr_1.1fr] md:px-8 md:py-14">
        <div className="flex flex-col justify-center">
          ...
          <h2 className="mt-2 font-display text-4xl leading-none text-[#123c2f] sm:text-5xl">First pool capped at $5.</h2>
        ...
        <div>
          <SignupPage defaultPromoCode="FIRSTPOOL5" promoSource="first-pool-5" />
        </div>
      </section>
    </main>
  )

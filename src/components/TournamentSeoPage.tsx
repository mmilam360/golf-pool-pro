...
const features = [
  ...
  'First 5 entries free, then $1 per extra active entry, capped at $25',
]
      ...
      <main className="mx-auto max-w-5xl px-5 py-12 md:py-16">
        ...
        <section className="mt-12 grid gap-8 md:grid-cols-[1fr_1fr]">
          ...
          <div className="border-2 border-[#123c2f] bg-[#fbf7ed] p-6 shadow-[7px_7px_0_#d8cab0]">
            ...
            <p className="mt-4 leading-7 text-[#4f5b52]">Small pools can run free. Bigger pools stay predictable: the host pays $1 for each active entry after the first 5, with a $25 max per pool.</p>

...
assert.match(email.text, /Please pay today so the host side stays current/)
assert.match(email.text, /Entries, picks, and leaderboards stay visible/)
assert.doesNotMatch(email.text, /temporarily hide the leaderboard/i)
